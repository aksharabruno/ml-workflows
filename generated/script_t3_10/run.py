...
grid_search = model_generation_5(X_train_subset_res, y_train_subset_res)
from task_06_data_preparation.task_06_data_preparation import data_preparation_6
X_test, X_train, y_test, y_train = data_preparation_6(df)
...
model_evaluation_10(X_test_embeddings, final_svm_model, label_encoder, y_test)
