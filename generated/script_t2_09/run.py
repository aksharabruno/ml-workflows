...
X_test_ids, X_test_mask, X_test_type, X_train_ids, X_train_mask, X_train_type, test_idx, train_idx, y_test, y_train = data_preparation_3(X_ids, X_mask, X_type, labels, texts)
from task_04_model_generation.task_04_model_generation import model_generation_4
history, model, model_path = model_generation_4(X_train_ids, X_train_mask, X_train_type, test_idx, train_idx, y_train)
from task_05_model_evaluation.task_05_model_evaluation import model_evaluation_5
model_evaluation_5(X_test_ids, X_test_mask, X_test_type, history, model, model_path, y_test)
